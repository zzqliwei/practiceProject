...
public class UserAgentUtil {
    ...
    public static void main(String[] args) {
        UserAgent userAgent = UserAgentUtil.getUserAgent("Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/67.0.3396.62 Safari/537.36");
