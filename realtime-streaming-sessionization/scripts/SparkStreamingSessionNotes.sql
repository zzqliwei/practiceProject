...
--num-executors 1 \
--executor-cores 1 \
--driver-java-options "-Dweb.streaming.shutdown.filepath=hdfs://master:9999/user/hadoop/real-time-analysis/shutdownfileflag" \
/home/hadoop/real-time-analysis/realtime-streaming-sessionization-1.0-SNAPSHOT-jar-with-dependencies.jar \
hdfs://master:8020/user/hadoop/real-time-analysis/output real_time_session s hdfs://master:9999/user/hadoop/real-time-analysis/checkpoint session master:9092 master:2181 /real_time_session \
>> /home/hadoop/real-time-analysis/SessionizeData_output.log 2>&1 &

# Apache Flume
apache-flume-1.8.0-bin/bin/flume-ng agent --conf conf --conf-file taildir_kafka_flume-conf.properties --name agent1

# 模拟写日志
scala -cp /home/hadoop/real-time-analysis/realtime-streaming-sessionization-1.0-SNAPSHOT.jar \
com.westar.sessionize.datamock.SessionDataFileWriter /home/hadoop/real-time-analysis/logs/user-visit.log 2000